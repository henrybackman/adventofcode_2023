...
class Hand():
    ...
    def __init__(self, hand: str, bid: int):
        ...
        self.mapped_hand = ''.join([self.card_map[card] for card in hand])
    ...
    def __lt__(self, other):
        if self.rank > other.rank:
            ...
            return self.mapped_hand > other.mapped_hand
        else:
            return False
    ...
    def get_rank(self):
        ...
        if distinct_cards == 1: # five of a kind
            return 1
        elif distinct_cards == 2 and (highest_count + joker_count) == 4: # four of a kind
            return 2
        elif distinct_cards == 2 and (highest_count + joker_count) == 3 and second_highest_count == 2: # full house
            return 3
        elif distinct_cards == 3 and (highest_count + joker_count) == 3: # three of a kind
            return 4
        elif (highest_count + joker_count) == 2 and second_highest_count == 2: # two pairs
            return 5
